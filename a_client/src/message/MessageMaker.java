...
public class MessageMaker extends CommunicationProtocol {
	...
	public static  ByteBuffer[] getBytebuffer_publicKey(byte[] message, String key)
			throws Exception {
		message = RSA_publicKey.encryptByPublicKey(message, key);
		return getBytebuffer(message, 0);
	}

	/* 用公钥加密只有一种情况，传递加密后的公钥确认信息 */
	public static  ByteBuffer[] getBytebuffer_publicKey(String message, String key)
			throws Exception {
